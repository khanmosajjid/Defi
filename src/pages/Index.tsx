...
export default function Index() {
  ...
  const heroStats = [
    { label: 'Total Staked', value: STATS.totalStaked, prefix: '' },
    { label: 'Treasury Balance', value: STATS.treasuryBalance, prefix: '' },
    { label: 'Market Value', value: STATS.marketValue, prefix: '' },
    { label: 'Current APY', value: STATS.currentAPY, prefix: '' }
  ];
  ...
  const features = [
    {
      ...
      description: 'Earn 0.4% every 8 hours with automatic compound interest. Your balance grows exponentially without any action required.',
    ...
    },
    {
      ...
      description: 'Building the world\'s first privacy and anonymous payment ecosystem based on advanced zk-SNARK technology.',
  ...
  const steps = [
    ...
    },
    {
      ...
      description: 'Vote on governance proposals and shape the protocol'
    }
  ];
                ...
                {heroStats.map((stat, index) => (
                  <div 
                    ...
                    className={`text-center transition-all duration-500 ${
                      currentStat === index ? 'scale-110 text-yellow-400' : 'text-gray-300'
                    }`}
                  >
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
            {features.map((feature, index) => (
              <Card key={index} className="bg-gradient-to-br from-gray-900 to-gray-800 border-yellow-500/20 hover:border-yellow-500/40 transition-all duration-300 group">
                <CardHeader>
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-yellow-400 font-semibold">{feature.highlight}</div>
                    </div>
                  </div>
                </CardHeader>
                <CardContent>
            ...
            <Card className="bg-gradient-to-br from-yellow-500/10 to-yellow-600/5 border-yellow-500/30">
              ...
              <CardContent className="space-y-4">
                <p className="text-gray-300">
                  The compound interest APY mechanism will make your income grow exponentially! 
                  Earn 0.4% every 8 hours with automatic compound interest.
                </p>
                <div className="flex justify-between text-sm">
                  <span className="text-gray-400">Current APY:</span>
                  <span className="text-yellow-400 font-semibold">{STATS.stakingAPY}</span>
                </div>
                <Link to="/stake">
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-400 max-w-3xl mx-auto">
              Based on zk-SNARK technology, we are building the world's first privacy public chain platform, 
              establishing a complete blockchain privacy ecosystem.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {[
              ...
              <div key={index} className="text-center p-4 bg-gray-900/50 rounded-lg border border-yellow-500/10 hover:border-yellow-500/30 transition-colors">
